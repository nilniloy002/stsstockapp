    ...
    <div class="offcanvas-md offcanvas-start bg-body-tertiary" tabindex="-1" id="sidebarMenu"
        ...
        <div class="offcanvas-body position-static sidebar-sticky d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto"
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                            <a class="nav-link {{ (request()->is('admin/asset-categories*')) ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                            <a class="nav-link {{ (request()->is('admin/asset-sub-categories*')) ? 'active' : '' }}"
                            href="{{ route('admin.asset-sub-categories.index') }}">
                                <span data-feather="users" class="align-text-bottom"></span>
                                Asset Sub Category
                            </a>
                    </li>
